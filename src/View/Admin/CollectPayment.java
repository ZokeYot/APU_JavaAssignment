...
public class CollectPayment extends javax.swing.JFrame {
    ...
    private String[] columnName = {"Payment ID", "Medical record ID", "Patient Name", "Payment Amount", "Payment Status"};

    public CollectPayment(Admin admin, AdminService adminService) throws FileNotFoundException{
        model.setColumnIdentifiers(columnName);
        try{
            FileReader fr = new FileReader("src\\Text Files\\payment.txt");
